...
namespace EDSDKLib
{
    ...
    public class SDKHandler : IDisposable
    {
        ...
        public delegate void ImageFilePathUpdate(string filePath); // KLM: added
        public delegate void CameraErrorHandler(uint errorID); // KLM: added
        ...
        /// <summary>
        /// KLM added: If an image is downloaded, this event fires with the downloaded image filepath.
        /// </summary>
        public event ImageFilePathUpdate NewImageDownloaded;
        /// <summary>
        /// KLM added: Fires if SDK throws an error.
        /// </summary>
        public event CameraErrorHandler CameraError;
        ...
        public void DownloadImage(IntPtr ObjectPointer, string directory)
        {
            ...
            SendSDKCommand(delegate
            {
                ...
                // KLM: added - Fire the event with the image path.
                if (NewImageDownloaded != null) NewImageDownloaded(CurrentPhoto);
